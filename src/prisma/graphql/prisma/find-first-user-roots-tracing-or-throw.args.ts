...
import { UserRootsTracingWhereInput } from '../user-roots-tracing/user-roots-tracing-where.input';
...
import { UserRootsTracingScalarFieldEnum } from '../user-roots-tracing/user-roots-tracing-scalar-field.enum';

@ArgsType()
export class FindFirstUserRootsTracingOrThrowArgs {
