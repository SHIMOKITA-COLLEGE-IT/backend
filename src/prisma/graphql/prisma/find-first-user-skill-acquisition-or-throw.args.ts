...
import { UserSkillAcquisitionWhereInput } from '../user-skill-acquisition/user-skill-acquisition-where.input';
import { Type } from 'class-transformer';
import { UserSkillAcquisitionOrderByWithRelationInput } from '../user-skill-acquisition/user-skill-acquisition-order-by-with-relation.input';
import { UserSkillAcquisitionWhereUniqueInput } from '../user-skill-acquisition/user-skill-acquisition-where-unique.input';
import { Int } from '@nestjs/graphql';
import { UserSkillAcquisitionScalarFieldEnum } from '../user-skill-acquisition/user-skill-acquisition-scalar-field.enum';

@ArgsType()
export class FindFirstUserSkillAcquisitionOrThrowArgs {
