...
import { SocialLinkWhereInput } from '../social-link/social-link-where.input';
import { Type } from 'class-transformer';
import { SocialLinkOrderByWithRelationInput } from '../social-link/social-link-order-by-with-relation.input';
import { SocialLinkWhereUniqueInput } from '../social-link/social-link-where-unique.input';
import { Int } from '@nestjs/graphql';
import { SocialLinkScalarFieldEnum } from '../social-link/social-link-scalar-field.enum';
