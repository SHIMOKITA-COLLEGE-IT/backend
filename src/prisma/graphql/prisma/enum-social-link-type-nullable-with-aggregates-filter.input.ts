...
import { NestedEnumSocialLinkTypeNullableWithAggregatesFilter } from './nested-enum-social-link-type-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumSocialLinkTypeNullableFilter } from './nested-enum-social-link-type-nullable-filter.input';

@InputType()
export class EnumSocialLinkTypeNullableWithAggregatesFilter {
