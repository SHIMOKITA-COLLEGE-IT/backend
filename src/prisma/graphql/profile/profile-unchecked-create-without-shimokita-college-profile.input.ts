...
import { SocialLinkUncheckedCreateNestedManyWithoutProfileInput } from '../social-link/social-link-unchecked-create-nested-many-without-profile.input';
...
@InputType()
export class ProfileUncheckedCreateWithoutShimokitaCollegeProfileInput {
    ...
    @Field(() => SocialLinkUncheckedCreateNestedManyWithoutProfileInput, {nullable:true})
