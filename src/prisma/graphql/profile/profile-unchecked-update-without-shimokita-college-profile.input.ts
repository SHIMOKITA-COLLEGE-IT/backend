...
import { TagUncheckedUpdateManyWithoutProfilesNestedInput } from '../tag/tag-unchecked-update-many-without-profiles-nested.input';
...
@InputType()
export class ProfileUncheckedUpdateWithoutShimokitaCollegeProfileInput {
    ...
    @Field(() => TagUncheckedUpdateManyWithoutProfilesNestedInput, {nullable:true})
